...
// NotionSourcesPanel owns the Notion-specific add form (URL + description) and
// list table. Each future provider (Slack, ...) will get its own panel with
// its own provider-specific columns and form fields.
