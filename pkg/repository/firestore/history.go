...
func (r *ticketHistoryRepository) historyCollection(workspaceID, ticketID string) *firestore.CollectionRef {
	return r.client.Collection("workspaces").Doc(workspaceID).Collection("tickets").Doc(ticketID).Collection("history")
}

func (r *ticketHistoryRepository) Create(ctx context.Context, workspaceID, ticketID string, h *model.TicketHistory) (*model.TicketHistory, error) {
...
func (r *ticketHistoryRepository) List(ctx context.Context, workspaceID, ticketID string) ([]*model.TicketHistory, error) {
