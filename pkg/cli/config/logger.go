...
func (x *Logger) Flags() []cli.Flag {
	return []cli.Flag{
		...
		&cli.StringFlag{
			...
			Category:    "logging",
			Aliases:     []string{"f"},
			Sources:     cli.EnvVars("SHEPHERD_LOG_FORMAT"),
		...
		&cli.StringFlag{
			Name:        "log-output",
			Category:    "logging",
			Sources:     cli.EnvVars("SHEPHERD_LOG_OUTPUT"),
		...
		&cli.BoolFlag{
			...
			Sources:     cli.EnvVars("SHEPHERD_LOG_QUIET"),
			Destination: &x.quiet,
		},
		&cli.BoolFlag{
			Name:        "log-stacktrace",
			...
			Sources:     cli.EnvVars("SHEPHERD_LOG_STACKTRACE"),
